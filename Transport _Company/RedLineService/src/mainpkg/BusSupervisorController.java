 ...
 * @author USER
 */
public class BusSupervisorController implements Initializable {
    ...
    @FXML
    private BorderPane busSupervisorBorder;
    @FXML
    private AnchorPane busSupervisorAnchorPane;
    ...
    private void createReportMenuItemOnClick(ActionEvent event) {
        try{
            ...
            busSupervisorBorder.setCenter(scene);
        } catch (IOException ex){
            System.out.println(ex);
        }
