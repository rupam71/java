...
public class DeliveryBoy extends Employee implements Reportable, Serializable{
    private String joinType;

    public DeliveryBoy() {}

    public DeliveryBoy(int id, String name, String gender,  String joinDate, String contractNo, float salary) {
        super(joinDate, contractNo, salary, id, name, gender);
        this.joinType = "Delivery Boy";
    }
