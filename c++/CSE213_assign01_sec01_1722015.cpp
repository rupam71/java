...
class City{
	...
	public:
		...
		setNeighborInformation() {
			cin.ignore();
			cout<<"Enter Neighbor City Name: "; getline(cin,name);
			cout<<"Enter Neighbor City Population: "; cin>>population;
			cout<<"Enter Neighbor City Area In Sq Km: "; cin>>areaInSqKm;
		}
		showCityInfo() {
...
class Graph{
	...
	public:
	    ...
	    friend getNeighborsOfcityName(Graph, string, City , int);
	    
};
		int operator += (int i, City neighborPtr){
			 i += neighborPtr.getPopulation();
			return i;
		}
...
//		g.neighborPtr = new City [n];
//			for(int i=0; i<n; i++) {
//				g.neighborPtr[i].setNeighborInformation();
//			}
//		}
